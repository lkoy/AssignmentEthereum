...
//        presenter.prepareView()
    ...
    override func setupComponents() {
        ...
        confirmButton = Button(style: .green)
    ...
    override func setupConstraints() {
        ...
        bottomConstraint = confirmButton.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: -ViewTraits.marginsButton.bottom)
...
//        presenter.phoneNumberEntered(textField.text)
    }
